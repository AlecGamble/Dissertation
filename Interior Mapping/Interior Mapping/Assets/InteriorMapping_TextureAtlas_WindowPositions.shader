...
Shader "Unlit/Interior Mapping/Basic/Texture Atlas With Windows"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float corner = roomIndexUV.x / (_RoomTex_ST.x-1);//abs(floor(i.uv.x  - _RoomTex_ST.x * 0.5) * 2) / _RoomTex_ST.x;
                return corner;
                return float4(roomIndexUV.xxx,1.0);
                ...
                return fixed4(lerp(room.rgb + specularReflection, facade.rgb, facade.a), 1.0);
            }
            ENDCG
        }
    }
